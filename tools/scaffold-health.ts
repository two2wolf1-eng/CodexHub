...
const expectedProjects = [
  ...
  'production-real-client-kernel',
  'real-client-calibration-kernel',
  'store-sqlite',
  'store-core',
  'task-closure-kernel',
  'ui-automation-kernel',
  'contracts',
  'codexhub-mcp-server',
  'orchestrator',
  'supervisor',
...
const requiredGovernanceFiles = [
  ...
  'docs/releases/m48-d12-approval-consumption-semantics.md',
  'docs/releases/m48-d13-github-boundary-audit.md',
  'docs/releases/m48-d14-deployment-boundary-audit.md',
  'docs/releases/m48-d15-secrets-policy-telemetry-audit.md',
  'docs/releases/m48-d16-controlled-write-boundary-audit.md',
  'docs/releases/m48-d17-runtime-external-agent-audit.md',
  'docs/releases/m48-d18-platform-operations-audit.md',
  'docs/releases/m48-d19-dashboard-mutation-surface.md',
  'docs/releases/m48-d20-cli-mutation-surface.md',
  'docs/releases/m48-d21-mcp-boundary-surface.md',
  'docs/releases/m48-d22-rehearsal-matrix-completeness.md',
  'docs/releases/m48-d23-operator-degraded-state-smoke.md',
  'docs/releases/m48-d24-adversarial-static-audit-expansion.md',
  'docs/releases/m48-d25-final-deep-governance-baseline.md',
  'docs/releases/m49-real-capability-development-queue.md',
  ...
  'docs/releases/m51.1-unified-metadata-contracts.md',
  'docs/releases/m51.2-unified-metadata-store.md',
  'docs/releases/m51.3-supervisor-metadata-projections.md',
  'docs/releases/m52.1-chatgpt-business-adapter-foundation.md',
  'docs/releases/m53.1-chrome-profile-registry-health.md',
  'docs/releases/m62-business-quota-contracts-store.md',
  'docs/releases/m63-real-readonly-governed-ui-automation.md',
  'docs/releases/m64-business-quota-supervisor-control-plane.md',
  'docs/releases/m65-business-quota-canary-hardening.md',
  'docs/releases/m65.5-business-quota-crosscheck-closeout.md',
  'docs/releases/m66-high-privilege-ui-authority.md',
  'docs/releases/m67-owner-admin-deep-extractor.md',
  'docs/releases/m68-business-member-reconciliation.md',
  'docs/releases/m69-codex-quota-fusion.md',
  'docs/releases/m70-privileged-business-data-store.md',
  'docs/releases/m71-admin-write-automation-cdp.md',
  'docs/releases/m72-canary-drift-hardening.md',
  'docs/releases/m73-real-client-direct-automation.md',
  'docs/releases/m74-production-sovereign-real-client-automation.md',
  'docs/releases/m75-codex-desktop-account-capacity-orchestration.md',
  'docs/releases/m75.5-real-rehearsal-acceptance.md',
  'docs/releases/m76-real-client-calibration.md',
  'docs/releases/m77-codex-desktop-structure-map.md',
  ...
  'docs/reviews/m48-d12-approval-consumption-semantics-review.md',
  'docs/reviews/m48-d13-github-boundary-audit-review.md',
  'docs/reviews/m48-d14-deployment-boundary-audit-review.md',
  'docs/reviews/m48-d15-secrets-policy-telemetry-audit-review.md',
  'docs/reviews/m48-d16-controlled-write-boundary-audit-review.md',
  'docs/reviews/m48-d17-runtime-external-agent-audit-review.md',
  'docs/reviews/m48-d18-platform-operations-audit-review.md',
  'docs/reviews/m48-d19-dashboard-mutation-surface-review.md',
  'docs/reviews/m48-d20-cli-mutation-surface-review.md',
  'docs/reviews/m48-d21-mcp-boundary-surface-review.md',
  'docs/reviews/m48-d22-rehearsal-matrix-completeness-review.md',
  'docs/reviews/m48-d23-operator-degraded-state-smoke-review.md',
  'docs/reviews/m48-d24-adversarial-static-audit-expansion-review.md',
  'docs/reviews/m48-d25-final-deep-governance-review.md',
  'docs/reviews/m49-real-capability-development-queue-review.md',
  ...
  'docs/reviews/m51.1-unified-metadata-contracts-review.md',
  'docs/reviews/m51.2-unified-metadata-store-review.md',
  'docs/reviews/m51.3-supervisor-metadata-projections-review.md',
  'docs/reviews/m52.1-chatgpt-business-adapter-foundation-review.md',
  'docs/reviews/m53.1-chrome-profile-registry-health-review.md',
  'docs/reviews/m62-business-quota-contracts-store-review.md',
  'docs/reviews/m63-real-readonly-governed-ui-automation-review.md',
  'docs/reviews/m64-business-quota-supervisor-control-plane-review.md',
  'docs/reviews/m65-business-quota-canary-hardening-review.md',
  'docs/reviews/m65.5-business-quota-crosscheck-closeout-review.md',
  'docs/reviews/m66-high-privilege-ui-authority-review.md',
  'docs/reviews/m67-owner-admin-deep-extractor-review.md',
  'docs/reviews/m68-business-member-reconciliation-review.md',
  'docs/reviews/m69-codex-quota-fusion-review.md',
  'docs/reviews/m70-privileged-business-data-store-review.md',
  'docs/reviews/m71-admin-write-automation-cdp-review.md',
  'docs/reviews/m72-canary-drift-hardening-review.md',
  'docs/reviews/m73-real-client-direct-automation-review.md',
  'docs/reviews/m74-production-sovereign-real-client-automation-review.md',
  'docs/reviews/m75-codex-desktop-account-capacity-orchestration-review.md',
  'docs/reviews/m75.5-real-rehearsal-acceptance-review.md',
  'docs/reviews/m76-real-client-calibration-review.md',
  'docs/reviews/m77-codex-desktop-structure-map-review.md',
  ...
  'docs/runbooks/m48-d25-final-deep-debug-runbook.md',
  'docs/runbooks/m49-real-capability-development-queue-runbook.md',
  ...
  'docs/runbooks/m51.1-unified-metadata-contracts-runbook.md',
  'docs/runbooks/m51.2-unified-metadata-store-runbook.md',
  'docs/runbooks/m51.3-supervisor-metadata-projections-runbook.md',
  'docs/runbooks/m52.1-chatgpt-business-adapter-foundation-runbook.md',
  'docs/runbooks/m53.1-chrome-profile-registry-health-runbook.md',
  'docs/runbooks/m62-business-quota-contracts-store-runbook.md',
  'docs/runbooks/m63-real-readonly-governed-ui-automation-runbook.md',
  'docs/runbooks/m64-business-quota-supervisor-control-plane-runbook.md',
  'docs/runbooks/m65-business-quota-canary-hardening-runbook.md',
  'docs/runbooks/m65.5-business-quota-crosscheck-closeout-runbook.md',
  'docs/runbooks/m66-high-privilege-ui-authority-runbook.md',
  'docs/runbooks/m67-owner-admin-deep-extractor-runbook.md',
  'docs/runbooks/m68-business-member-reconciliation-runbook.md',
  'docs/runbooks/m69-codex-quota-fusion-runbook.md',
  'docs/runbooks/m70-privileged-business-data-store-runbook.md',
  'docs/runbooks/m71-admin-write-automation-cdp-runbook.md',
  'docs/runbooks/m72-canary-drift-hardening-runbook.md',
  'docs/runbooks/m73-real-client-direct-automation-runbook.md',
  'docs/runbooks/m74-production-real-client-automation-runbook.md',
  'docs/runbooks/m75-codex-desktop-account-capacity-runbook.md',
  'docs/runbooks/m75.5-real-rehearsal-acceptance-runbook.md',
  'docs/runbooks/m76-real-client-calibration-runbook.md',
  'docs/runbooks/m77-codex-desktop-structure-map-runbook.md',
...
const requiredContractExports = [
  ...
  'PrivilegedBusinessDataKindSchema',
  'PrivilegedBusinessAccessKindSchema',
