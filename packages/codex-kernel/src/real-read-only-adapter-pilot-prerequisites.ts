...
function createPilotPrerequisiteGates(input: {
  ...
  const gateInputs: Array<{
    ...
    },
    {
      ...
      category: 'authority',
      passed: input.authoritativeAttemptEvidencePresent,
      required: true,
      blockedSummary: 'Persisted Supervisor-backed attempt or timeline evidence is required.',
      passedSummary: 'Persisted authoritative attempt evidence is present.',
    },
    {
