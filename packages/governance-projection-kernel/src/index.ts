...
const SOURCE_ALIASES: Record<string, UnifiedRunSource> = {
  ...
  release_candidate_run: 'orchestrator',
  m11_pilot: 'orchestrator',
  custom_workflow_run: 'orchestrator',
  github_metadata_run: 'github',
  github_draft_pr_run: 'github',
  github_branch_publish_run: 'github',
  github_publish_draft_pr_chain_run: 'github',
  github_pr_lifecycle_run: 'github',
  github_remote_cleanup_run: 'github',
  remote_supersede_run: 'github',
